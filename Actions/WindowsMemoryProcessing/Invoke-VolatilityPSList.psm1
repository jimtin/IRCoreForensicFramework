function Invoke-VolatilityPSList {
    ...
    $outcome.Add("PSListResults", $volatilityobjects)

    # Output to a file in case future forensic work is needed
    # Create the file string
    $outfilestring = "C:\ExtractionDirectory\" + $target + "_ForensicArtifacts\ProcessedArtefacts\VolatilityPsListResults.json"
